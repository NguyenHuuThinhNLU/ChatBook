...
public class DateTimeFormatter {
    ...
    Map<Long, Function<Instant, String>> strategyMap = new LinkedHashMap<>(); // DùngLinkedHashMap để giữ lại thứ tự khi đi qua
    ...
    public String format(Instant instant) {
        long elapseSeconds = ChronoUnit.SECONDS.between(instant, Instant.now()); // Khoang cach thoi gian giua luc tao bai voi thoi gian hien tai
