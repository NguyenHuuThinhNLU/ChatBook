...
@Component //Bean annotation to register this filter as a Spring bean
@Slf4j
...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String token = authHeader.get(0).replace("Bearer ", ""); // Truoc token la "Bearer " nên phai thay the no di
