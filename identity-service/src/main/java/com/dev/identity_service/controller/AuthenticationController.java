...
import com.dev.identity_service.dto.request.*;
...
public class AuthenticationController {
    ...
    ApiResponse<IntrospectResponse> aythenticate(@RequestBody IntrospectRequest request) throws ParseException, JOSEException {
